@echo off
REM FitVerse Quick Setup Script for Windows
REM Run this after setting up Firebase and EmailJS
...
(
echo # Firebase Configuration - UPDATE WITH YOUR VALUES
...
echo.
echo # EmailJS Configuration - UPDATE WITH YOUR VALUES
echo VITE_EMAILJS_PUBLIC_KEY=your_emailjs_public_key
echo VITE_EMAILJS_SERVICE_ID=your_emailjs_service_id
echo VITE_EMAILJS_TEMPLATE_ID=template_workout_reminder
) > .env
